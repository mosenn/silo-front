...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-2 py-2 rounded-md   font-semibold  text-center relative overflow-hidden",
        className
      )}
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[20%]  md:max-w-[40%] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
