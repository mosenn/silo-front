...
import DashboardUser from "../Dashboard/ContentDashboard";
  ...
  const [selectedTab, setSelectedTab] = useState<string>("allProducts");
    ...
    const renderContent = () => {
      switch (selectedTab) {
        ...
        case "settings":
          return <div className="w-full h-full bg-gray-100">تنظیمات</div>;
       
        default:
          return <div className="w-full h-full bg-gray-100"><DashboardUser/></div>;
      }
    };
